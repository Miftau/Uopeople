...
public class SimpleFileChooser {
	...
	private static JFileChooser dialog;  // The dialog, which is created when needed.
	 ...
	 * @return the selected file, or null if the user did not select a file.
	 */
	public static File getInputFile(Component parent, String dialogTitle) {
		if (dialog == null)
			dialog = new JFileChooser();
		if (dialogTitle != null)
	 ...
	 * @return the selected file, or null if the user did not select a file.
	 */
	public static File getOutputFile(Component parent, 
